...
from src.slack.repository.slack_setting.slack_setting_repo import SlackSettingRepository
...
class SlackSettingService:
    ...
    async def create_slack_setting(self, vo: DefaultSlackSettingVo) -> int:
        try:
            ...
            raise RepositoryError("Failed to insert slack_setting.") from e
    ...
    async def find_slack_settings(self, vo: SlackSettingFilterVo) -> List[DefaultSlackSettingVo]:
        try:
            ...
            raise RepositoryError("Failed to select slack_setting.") from e
    ...
    async def find_active_by_process(self, process_name: str) -> Optional[DefaultSlackSettingVo]:
        try:
            ...
            raise RepositoryError("Failed to select slack_setting by process.") from e

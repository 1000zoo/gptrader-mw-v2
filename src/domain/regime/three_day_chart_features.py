...
THREE_DAY_CHART_FEATURE_REGISTRY_V1 = (
    ...
    _spec("breakout_rate_3d", "structure", 15, 4320, "fraction of 15m closes outside the preceding 24h high-low range"),
    _spec("mean_body_ratio_3d", "structure", 60, 4320, "mean absolute 1h candle body / candle range; zero-range hour contributes 0"),
    _spec("mean_upper_wick_ratio_3d", "structure", 60, 4320, "mean 1h upper wick / candle range; zero-range hour contributes 0"),
    _spec("mean_lower_wick_ratio_3d", "structure", 60, 4320, "mean 1h lower wick / candle range; zero-range hour contributes 0"),

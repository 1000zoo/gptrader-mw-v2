...
- `ddl/tables/`: 테이블별 `CREATE TABLE` DDL
- `ddl/indexes/`: 테이블별 또는 기능별 인덱스 DDL
- `ddl/constraints/`: FK, CHECK, UNIQUE 등 별도 제약조건 DDL
...
- 테이블 변경에 맞춰 `ddl/indexes`, `ddl/constraints`, `tests`를 함께 확인했는가
...
- 테이블 DDL: `ddl/tables/<table_name>.sql`
- 인덱스 DDL: `ddl/indexes/<table_name>_indexes.sql`
- 제약조건 DDL: `ddl/constraints/<table_name>_constraints.sql`

...
- `done`: 세부 스펙과 `sql/ddl` DDL 파일 또는 SQLite adapter 구현이 있다.

| Domain | Table | Spec | Status | Source |
|--------|-------|------|--------|--------|
| account | `account_snapshots` | `docs/plan/sql/account/account_snapshots.md` | `done` | `AccountSnapshot` |
| account | `asset_balances` | `docs/plan/sql/account/asset_balances.md` | `done` | `AssetBalance` |
| application | `research_runs` | `docs/plan/sql/application/research_runs.md` | `done` | research usecases |
| application | `strategy_lifecycle_runs` | `docs/plan/sql/application/strategy_lifecycle_runs.md` | `done` | strategy lifecycle usecases |
| application | `trade_runs` | `docs/plan/sql/application/trade_runs.md` | `done` | trade usecases |
| execution | `execution_reports` | `docs/plan/sql/execution/execution_reports.md` | `done` | `ExecutionReport` |
| execution | `order_requests` | `docs/plan/sql/execution/order_requests.md` | `done` | `OrderRequest` |
| execution | `order_results` | `docs/plan/sql/execution/order_results.md` | `done` | `OrderResult` |
| indicator | `indicator_sets` | `docs/plan/sql/indicator/indicator_sets.md` | `done` | `IndicatorSet` |
| indicator | `indicator_values` | `docs/plan/sql/indicator/indicator_values.md` | `done` | `IndicatorValue` |
| lifecycle | `promotion_policies` | `docs/plan/sql/lifecycle/promotion_policies.md` | `done` | `PromotionPolicy` |
| lifecycle | `strategy_evaluation_metrics` | `docs/plan/sql/lifecycle/strategy_evaluation_metrics.md` | `done` | `StrategyEvaluation.metrics` |
...
| market | `candles` | `docs/plan/sql/market/candles.md` | `done` | `Candle` |
| market | `market_snapshot_candles` | `docs/plan/sql/market/market_snapshot_candles.md` | `done` | `MarketSnapshot.candles` |
| market | `market_snapshots` | `docs/plan/sql/market/market_snapshots.md` | `done` | `MarketSnapshot` |
| position | `position_events` | `docs/plan/sql/position/position_events.md` | `done` | `PositionEvent` |
| position | `positions` | `docs/plan/sql/position/positions.md` | `done` | `Position` |
| risk | `exposure_limits` | `docs/plan/sql/risk/exposure_limits.md` | `done` | `ExposureLimit` |
| risk | `position_sizer_configs` | `docs/plan/sql/risk/position_sizer_configs.md` | `done` | `PositionSizer` config |
| risk | `position_sizes` | `docs/plan/sql/risk/position_sizes.md` | `done` | `PositionSize` |
| risk | `risk_checks` | `docs/plan/sql/risk/risk_checks.md` | `done` | `RiskCheck` |
| risk | `risk_policies` | `docs/plan/sql/risk/risk_policies.md` | `done` | `RiskPolicy` |
| signal | `signal_logs` | `docs/plan/sql/signal/signal_logs.md` | `done` | `SignalLogEntry`, current DDL/adapter |
| signal | `signal_reasons` | `docs/plan/sql/signal/signal_reasons.md` | `done` | `SignalReason` |
| signal | `signals` | `docs/plan/sql/signal/signals.md` | `done` | `Signal` |
| signal | `trade_decisions` | `docs/plan/sql/signal/trade_decisions.md` | `done` | `TradeDecision` |
| signal_generator | `generated_signals` | `docs/plan/sql/signal_generator/generated_signals.md` | `done` | `GeneratedSignal` |
...
| signal_generator | `signal_generator_regime_routes` | `docs/plan/sql/signal_generator/signal_generator_regime_routes.md` | `done` | `regime_routes` |
| signal_generator | `signal_generator_strategy_links` | `docs/plan/sql/signal_generator/signal_generator_strategy_links.md` | `done` | `strategy_ids` |
| strategy | `strategy_definitions` | `docs/plan/sql/strategy/strategy_definitions.md` | `done` | `StrategyDefinition`, current DDL/adapter |
| strategy | `strategy_results` | `docs/plan/sql/strategy/strategy_results.md` | `done` | `StrategyResult` |
...
다음 단계는 `positions`, `position_events`, `order_requests`, `order_results`, `execution_reports`부터 repository port와 persistence adapter 필요 범위를 검토하는 것이다.
